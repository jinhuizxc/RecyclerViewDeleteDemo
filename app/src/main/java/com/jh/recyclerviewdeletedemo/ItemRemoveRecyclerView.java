 ...
 *
 * VelocityTracker相关
 * http://blog.sina.com.cn/s/blog_628cc2b70102vowg.html
 *
 */
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    mItemLayout = viewHolder.item_layout;
                    ...
                    mDelete.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            onItemClickListener.onDeleteClick(mPosition);
            ...
            case MotionEvent.ACTION_UP:
                if (!isItemMoving && !isDragging && onItemClickListener != null) {
